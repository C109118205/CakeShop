...
public class SqlDataShopBaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DataBaseName = "DataShopOrder";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String SqlTable = "CREATE TABLE IF NOT EXISTS DataShopOrder (" +
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        final String SQL = "DROP TABLE DataShopOrder";
